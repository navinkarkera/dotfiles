...
sudo pacman -Syy --needed neovim tmux alacritty stow paru zsh bat fd ripgrep exa fzf broot zoxide xsel btop ttf-firacode-nerd lazygit git-delta glow nitrogen pass xdotool timew pueue bc ttf-ibmplex-mono-nerd dunst at
paru -S --needed smug go-jira-bin nvm nerd-fonts-anonymous-pro tmux-plugin-manager-git git-extras

cd $HOME/dotfiles
stow alacritty nvim tmux zsh shell project-scripts xprofile i3 fontconfig git smug jira glow pueue dunst
# chsh -s $(which zsh)
